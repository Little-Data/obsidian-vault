---
标题: "[Git].gitignore文件的配置使用"
来源: https://zhuanlan.zhihu.com/p/52885189
发布者: 知乎专栏
发布日期: 2018-12-20 18:45
创建日期: 2018-12-20 18:50
描述: 在使用Git的过程中，有的文件比如日志，临时文件，编译的中间文件等不要提交到代码仓库，这时就要设置相应的忽略规则，来忽略这些文件的提交。简单来说一个场景：在你使用git add .的时候，遇到了把你不想提交的文…
tags:
  - clippings
  - 知乎专栏
  - 番茄不炒蛋
